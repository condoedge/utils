(() => {
    ...
    function updateFloatingFromAfter(
        balloonContainer,
        floating,
        ...
        const bottom =
            parseFloat(afterStyles.getPropertyValue("bottom")) || null;
        ...
        if (
            right !== null &&
            afterStyles.getPropertyValue("right") !== "auto"
        ) {
            finalLeft =
                balloonContainerRect.right -
                right -
        ...
        if (
            bottom !== null &&
            afterStyles.getPropertyValue("bottom") !== "auto"
        ) {
            finalTop =
                balloonContainerRect.bottom -
                bottom -
